...
SendWebhook(stats) {
    global MacroStartTime, webhook, DiscordUserID, wins,totalMatch, roundStart, prensentprize
    ...
    statsText .= "**Presents:** " prensentprize "`n"
...
TestWebhook() {
    global MacroStartTime, webhook, DiscordUserID, wins,totalMatch, prensentprize
