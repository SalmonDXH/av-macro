...
global coords := [
    ...
    Map( ; Bleach
        "Slot1", [[350, 221], [360, 148], [360, 304]],
        "Slot2", [[242, 367], [224, 71], [520, 233]],
        "Slot3", [[321, 163], [318, 235], [441, 225]],
        "Slot4", [[149, 236], [444, 171], [360, 344]],
        "taka", [[557, 134]],
        "speed", [[629, 181], [587, 316], [592, 387]]
    ),

    Map( ; Double Dungeon
        "Slot1", [[132, 242], [156, 321], [102, 352]],
        "Slot2", [[69, 105], [301, 143], [178, 520]],
        "Slot3", [[104, 295], [94, 256], [66, 240]],
        "Slot4", [[53, 196], [196, 270], [193, 361]],
        "taka", [[581, 290]],
        "speed", [[499, 122], [583, 136], [582, 211]]
    ),

    Map( ; Underground
        "Slot1", [[398, 314], [220, 289], [219, 127]],
        "Slot2", [[271, 90], [136, 130], [369, 309]],
        "Slot3", [[315, 267], [46, 249], [342, 45]],
        "Slot4", [[92, 499], [199, 498], [283, 130]],
        "taka", [[597, 320]],
        "speed", [[409, 105], [408, 49], [352, 109]]
    ),
]
...
antiSoftLock() {
        ...
        if (fixed and !fixed2) {
            ...
            if (portalcoord := SearchForPortal("Love",mapStarter)) {
               ...
               AddToLog("Couldn't find " maps[mapStarter][3] " portal, Searching for another portal")
                ...
                while (mapStarter < coords.Length + 1 and !portalcoord := SearchForPortal("Love",mapStarter)) {
    ...
    if (ok := FindText(&X, &Y, 616, 213, 865, 262, 0, 0, reward)) {
        ...
        for index, text in maps {
            MouseMove(297, 278)
            Sleep 1000
            if (ok := FindText(&X, &Y, 529, 250, 1127, 611, 0, 0, maps[A_Index][1]) || ok := FindText(&X, &Y, 529, 250, 1127, 611, 0, 0, maps[A_Index][2])) {
