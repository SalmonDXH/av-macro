...
PlacementGUI.Add("GroupBox", "x40 y80 w200 h275 " HeaderColor " +Center", "Slot 1")
...
global Slot1Placement := PlacementGUI.Add("DropDownList", "x60 y240 w160", [1,2,3,4,5])
...
global Slot1SkillClick := PlacementGUI.Add("DropDownList", "x60 y315 w160", [0,1,2])
Slot1SkillClick.Choose(1)


;global Slot 2
PlacementGUI.SetFont("s16 bold", "Segoe UI")
PlacementGUI.Add("GroupBox", "x280 y80 w200 h275 " HeaderColor " +Center", "Slot 2")
PlacementGUI.SetFont("s10", "Segoe UI")
...
global Slot2Placement := PlacementGUI.Add("DropDownList", "x300 y240 w160", [1,2,3,4,5])
...
global Slot2SkillClick := PlacementGUI.Add("DropDownList", "x300 y315 w160", [0,1,2])
Slot2SkillClick.Choose(1)


;global Slot 3
PlacementGUI.SetFont("s16 bold", "Segoe UI")
PlacementGUI.Add("GroupBox", "x520 y80 w200 h275 " HeaderColor " +Center", "Slot 3")
PlacementGUI.SetFont("s10", "Segoe UI")
...
global Slot3Placement := PlacementGUI.Add("DropDownList", "x540 y240 w160", [1,2,3,4,5])
...
global Slot3SkillClick := PlacementGUI.Add("DropDownList", "x540 y315 w160", [0,1,2])
Slot3SkillClick.Choose(1)

;global Slot 4
PlacementGUI.SetFont("s16 bold", "Segoe UI")
PlacementGUI.Add("GroupBox", "x760 y80 w200 h275 " HeaderColor " +Center", "Slot 4")
PlacementGUI.SetFont("s10", "Segoe UI")
...
global Slot4Placement := PlacementGUI.Add("DropDownList", "x780 y240 w160", [1,2,3,4,5])
...
global Slot4SkillClick := PlacementGUI.Add("DropDownList", "x780 y315 w160", [0,1,2])
Slot4SkillClick.Choose(1)


Strats := PlacementGUI.Add("Checkbox","x60 y30 w250 cWhite", "Single Slot Upgrade strategy")
Mode := PlacementGUI.Add("Checkbox","x60 y50 w250 cWhite", "Easy Mode (Full buff)")
...
PlacementGUI.BackColor := BackgroundColor
...
SavePlacement() {
    ...
    mode_path := A_ScriptDir "\Lib\UnitPlacements\mode.txt"
    ...
    try {
        ...
        FileDelete(mode_path)
        FileAppend(modetext, mode_path, "UTF-8")
    } catch {
...
LoadMode(){
    file_path := A_ScriptDir "\Lib\UnitPlacements\mode.txt"
    if !FileExist(file_path) {
        MsgBox("No saved data found. Using default values.")
        return {}
    }
