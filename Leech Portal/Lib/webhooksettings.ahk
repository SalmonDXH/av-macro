...
EndWebhook() {
    global MacroStartTime,webhook, DiscordUserID, portals
    ...
    ; Prepare the stats text
    statsText := "**Portals claimed:** " portals
...
WebhookGUI.BackColor := BackgroundColor
